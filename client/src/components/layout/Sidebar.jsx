...
export default function Sidebar({ isOpen, onClose }) {
  return (
    <>
      ...
      <aside className="hidden lg:block fixed top-16 left-0 bottom-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 overflow-hidden">
        <SidebarContent />
      </aside>
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-16 left-0 bottom-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 shadow-2xl lg:hidden overflow-hidden"
            >
